      ...
      <section className="flex flex-grow items-center justify-center bg-port sm:p-5">
        <div className="flex">
            <div className="t-bg p-3 rounded-none md:rounded-lg text-white">
              <div className="md:float-right float-none text-center">
                <LazyLoadImage placeholderSrc={myFace} effect="black-and-white" src={myFace} className="border border-black shadow-2xl rounded-full md:h-72 md:w-72 h-96 w-96" />
              </div>
              <p className={pStyle}>
