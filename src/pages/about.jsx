        ...
        <div className="flex">
            <div className="t-bg p-3 rounded-none md:rounded-lg text-white">
              <div className="flex flex-col space-y-4 md:float-right float-none text-center">
                <LazyLoadImage placeholderSrc={myFace} effect="black-and-white" src={myFace} className="shadow-2xl rounded-full md:h-72 md:w-72 h-96 w-96 mx-auto md:mx-none" />
              ...
              <p className={pStyle}>
              <span className={hStyle}>Hey! My name is Jason Palmeri</span>, I'm {age} years old with a Bachelors in Software Development. Graduating at Bellevue University in 2023 for their Software Development Bachelors Program</p>
              <br/>
              ...
              <p className={pStyle}>I am always open to new project ideas and opportunities, so feel free to <NavLink className={'text-purple-300 hover:underline'} to={'/connect'}>Connect</NavLink> with me</p>
            </div>
        </div>
      </section>
    </Layout>
